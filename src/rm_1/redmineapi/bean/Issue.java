...
public class Issue implements Identifiable {
  ...
  /**
     ...
     * @see rm_1.redmineapi.Include#journals
     */
     ...
     * @see rm_1.redmineapi.Include#changesets
     */
     ...
     * </pre>
     * @return unmodifiable collection of entries or empty collection if no objects found.
     * @see rm_1.redmineapi.Include#watchers
     */
    ...
    /**
      ...
      * @see rm_1.redmineapi.Include#children
      */
     ...
     * @see rm_1.redmineapi.Include#relations
     */
     ...
     * </pre>
     * @return unmodifiable collection of entries or empty collection if no objects found.
     * @see rm_1.redmineapi.Include#attachments
     */
