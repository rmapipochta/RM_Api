...
import rm_1.redmineapi.internal.DirectObjectsSearcher;
import rm_1.redmineapi.internal.Joiner;
import rm_1.redmineapi.internal.ResultsWrapper;
...
public class IssueManager {
     ...
     *
     * @see rm_1.redmineapi.bean.IssueRelation.TYPE
     */
    ...
    /**
     * delivers a list of {@link rm_1.redmineapi.bean.IssueCategory}s of a {@link Project}
     *
     * @param projectID the ID of the {@link Project}
     * @return the list of {@link rm_1.redmineapi.bean.IssueCategory}s of the {@link Project}
    ...
    /**
     * Delivers a list of existing {@link rm_1.redmineapi.bean.IssueStatus}es.
     *
     * @return a list of existing {@link rm_1.redmineapi.bean.IssueStatus}es.
     * @throws RedmineAuthenticationException thrown in case something went wrong while trying to login
     * @throws RedmineException        thrown in case something went wrong in Redmine
     * @throws NotFoundException       thrown in case an object can not be found
     */
    ...
    /**
     * @return a list of all {@link rm_1.redmineapi.bean.Tracker}s available (like "Bug", "Task", "Feature")
     * @throws RedmineAuthenticationException thrown in case something went wrong while trying to login
     * @throws RedmineException        thrown in case something went wrong in Redmine
     * @throws NotFoundException       thrown in case an object can not be found
     */
